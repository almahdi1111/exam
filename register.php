...
<div class="main">
<h1>نظام الامتحانات - تسجيل المستخدم</h1>
	...
	<form action="" method="post">
        ...
        <br/>
        <p style="font-size: 16px; text-align: center">مسجل بالفعل؟<a style="text-decoration: none" href="index.php">سجل الدخول</a> هنا</p>
        <br/>
